...
public class TestBase {
	...
	public TestBase() throws Exception {
		prop = new Properties();
		ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\main\\java\\com\\Job_Preparation_Magento\\Config\\Config.properties");
	    prop.load(ip);
	    
	    dataProp = new Properties();
	    ip = new FileInputStream( System.getProperty("user.dir") + "\\src\\test\\java\\com\\Magento\\testData\\testData.properties");	    
	    dataProp.load(ip);
	}
